...
from resume.serializers import LanguageSerializer, EducationInformationSerializer, WorkExperienceSerializer, ProfileDescriptionSerializer, ContactDataSerializer, PersonalDataSerializer, ProfileSerializer
